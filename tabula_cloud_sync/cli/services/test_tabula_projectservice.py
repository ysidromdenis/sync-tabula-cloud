"""
Servicio personalizado para test_tabula_project.
...
class testtabulaprojectService(TabulaCloudService):
    """Servicio personalizado para test_tabula_project."""
    ...
    def on_start(self) -> None:
        ...
        self.logger.info("=== Iniciando test_tabula_project Service ===")
    ...
    def on_stop(self) -> None:
        ...
        self.logger.info("=== Deteniendo test_tabula_project Service ===")
...
if __name__ == "__main__":
    service = testtabulaprojectService()
    service.start()
